...
**Language scope:** English, French, and Chinese — see [README_FR.md](README_FR.md) and [README_ZH.md](README_ZH.md)
...
**Lesson:** [Open Lesson 2](lessons/en/0002-trace-one-question.html)
...
**Lesson:** [Open Lesson 3](lessons/en/0003-build-a-trustworthy-evaluation-set.html)
...
**Lesson:** [Open Lesson 4](lessons/en/0004-establish-the-mvp-baseline.html)
...
**Lesson:** [Open Lesson 5](lessons/en/0005-semantic-keyword-and-hybrid-retrieval.html) · [Reference](reference/en/semantic-keyword-and-hybrid-retrieval-cheatsheet.html)
...
**Lesson:** [Open Lesson 6](lessons/en/0006-chunking-and-document-structure.html) · [Reference](reference/en/chunking-and-document-structure-cheatsheet.html)
...
**Lesson:** [Open Lesson 7](lessons/en/0007-metadata-filters-and-access-boundaries.html) · [Reference](reference/en/metadata-filters-and-access-boundaries-cheatsheet.html)
...
**Lesson:** [Open Lesson 8](lessons/en/0008-query-handling-and-reranking.html) · [Reference](reference/en/query-handling-and-reranking-cheatsheet.html)
...
**Lesson:** [Open Lesson 9](lessons/en/0009-context-assembly-and-evidence-budgets.html) · [Reference](reference/en/context-assembly-and-evidence-budgets-cheatsheet.html)
...
**Lesson:** [Open Lesson 10](lessons/en/0010-prompts-that-answer-only-from-evidence.html) · [Reference](reference/en/prompts-that-answer-only-from-evidence-cheatsheet.html)
...
**Lesson:** [Open Lesson 11](lessons/en/0011-citation-design-and-source-fidelity.html) · [Reference](reference/en/citation-design-and-source-fidelity-cheatsheet.html)
...
**Lesson:** [Open Lesson 12](lessons/en/0012-refusal-uncertainty-and-hallucination-control.html) · [Reference](reference/en/refusal-uncertainty-and-hallucination-control-cheatsheet.html)
...
**Lesson:** [Open Lesson 13](lessons/en/0013-failure-isolation-and-graceful-degradation.html) · [Reference](reference/en/failure-isolation-and-graceful-degradation-cheatsheet.html)
...
**Lesson:** [Open Lesson 14](lessons/en/0014-latency-cost-and-observability.html) · [Reference](reference/en/latency-cost-and-observability-cheatsheet.html)
...
**Lesson:** [Open Lesson 15](lessons/en/0015-security-permissions-and-deployment-boundaries.html) · [Reference](reference/en/security-permissions-and-deployment-boundaries-cheatsheet.html)
...
**Lesson:** [Open Lesson 16](lessons/en/0016-pilot-review-and-30-day-implementation-plan.html) · [Reference](reference/en/pilot-review-and-30-day-implementation-plan-cheatsheet.html)
...
## Continuing education (outside the 16-lesson syllabus)

### Lesson 17 — What comes after the pilot

**Goal:** Know where to go once a pilot is running and real users, feedback, and failures start showing up.
**Practice:** Match your own pilot's weakest spot to the right chapter of `rag-formation-continue`, a separate, free tutorial series written from real production experience.
**Artifact:** One production-readiness change you'd make next, tied to a specific gap from your own Lesson 16 worksheet.
**Lesson:** [Open Lesson 17](lessons/en/0017-what-comes-after-the-pilot.html) · [rag-formation-continue on GitHub](https://github.com/scheffershen/rag-formation-continue)

This lesson isn't numbered into Phases 1–4 above and isn't required for the
...
- [RAG quality cheat sheet](reference/en/rag-quality-cheatsheet.html)
- [Lesson 1](lessons/en/0001-from-question-to-cited-answer.html)
