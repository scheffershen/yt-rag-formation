...
Une non-conformite peut etre ouverte a partir d'une reclamation client qualifiee selon PR-CLI-MRD-013, d'un ecart releve lors d'un audit fournisseur conduit selon PR-ACH-MRD-007, ou d'une anomalie detectee lors d'une revue de pistes d'audit selon SOP-QA-MRD-015. Le circuit de classification et de cloture reste identique quelle que soit son origine.
