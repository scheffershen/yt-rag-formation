# TEAM-ITS-MRD-001 - Organisation de l'equipe Systemes d'Information

| Champ | Valeur | Champ | Valeur |
|---|---|---|---|
| Reference | TEAM-ITS-MRD-001 | Version | V8 |
| Type | Fiche d'organisation | Mise en activite | 2025-06-02 |
| Entite | Meridian Labs - Systemes d'Information | Redacteur | Julien Kessler |
| Statut | En activite | Approbateur | Marc Villeneuve |

## 1. Objet

Ce document decrit la composition, les roles et les responsabilites de l'equipe Systemes d'Information de Meridian Labs.
...
Le role de RSSI est porte par Julien Kessler en complement de la fonction de Directeur des Systemes d'Information.

## 3. Astreinte

Une astreinte technique hebdomadaire est assuree par rotation entre les membres de l'equipe Infrastructure. Le planning est publie le 25 de chaque mois pour le mois suivant.
