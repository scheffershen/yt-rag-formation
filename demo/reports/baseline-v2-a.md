# RAG evaluation - baseline-v2-a

- run at: 2026-08-14T11:27:12+00:00
...
- judge: Correct figure for serious cases, but additional information about unexpected cases is not in the reference.
...
- judge: Missing mention of 7 non bloquants risks.
...
- judge: Mentions minimum requirement but omits recommended amount.
...
- judge: Mentions a different measure and document than the reference answer.
...
- judge: Missing specific non-conformity classification and 90-day action plan deadline.
...
- judge: Mentions related procedures but does not directly answer the recall process.
...
- judge: Missing specific reference to non-conformity document (PR-QA-MRD-009).
